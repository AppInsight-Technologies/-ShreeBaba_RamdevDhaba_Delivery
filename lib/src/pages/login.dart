    ...
    debugPrint("entered login.......");
     try {
      ...
      final response = await http.post(url,body: { // await keyword is used to wait to this operation is complete.
        ...
        "branch": IConstants.branch.toString(),
        "branchtype": "0",
        "mode": "0"
          }
      );
            ...
            children: <Widget>[
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: /*Theme.of(context).accentColor*/Colors.white),
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            onFieldSubmitted: (val){
                              context.nextEditableFocus();// context.nextEditableTextFocus();
                            },
