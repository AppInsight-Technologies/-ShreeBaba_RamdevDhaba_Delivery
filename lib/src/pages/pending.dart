    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: new IconButton(
          icon: new Icon(Icons.arrow_back_ios, color: /*Theme.of(context).hintColor*/Colors.black),
          onPressed: () => Navigator.of(context).pop()
        ),
        automaticallyImplyLeading: false,
        backgroundColor: /*Colors.transparent*//*Theme.of(context).accentColor*/Colors.white,
        elevation: 0,
        centerTitle: true,
                     ...
                     child: Container(
                       ...
                       child: Column(
                         children: [
                           Row(
                             ...
                             children: [
                               ...
                               Row(
                                 children: [
                                   Text(PendingData.pendingitems[i].orderStatus.toString(),style: TextStyle(color: (PendingData.pendingitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFFE96124),fontSize:14,fontWeight: FontWeight.w600),),
                                   SizedBox(width: 2,),
                                   Image.asset(
                                     PendingData.pendingitems[i].img,
                                     // fit: BoxFit.fill,
                                     //color: (PendingData.pendingitems[i].orderStatus=="Delivered")?Theme.of(context).accentColor:Color(0xFFE96124),
                                     width: 15.0,
                                     height: 15.0,
                                   ),
                                 ],
                         ...
                         trailing: Column(
                           ...
                           children: [
                             Text(PendingData.pendingitems[i].orderStatus.toString(),style: TextStyle(color: Color(0xFFE96124),fontSize:14,fontWeight: FontWeight.w600),),
                             GestureDetector(
                               onTap: (){
                                 Navigator.of(context).pushNamed('/OrderDetails',
                                   arguments: RouteArgument(
                               ...
                               child: Container(
                                 ...
                                 width: 100,
                                 decoration: BoxDecoration(
                                     border:Border.all(color:(PendingData.pendingitems[i].orderstatus=="completed")?Color(0xFFE96124):Theme.of(context).accentColor,)
                                 ),
                                 child: Center(child: Text('View Details',style: TextStyle(fontWeight: FontWeight.w500,color: (PendingData.pendingitems[i].orderstatus=="completed")?Color(0xFFE96124):Theme.of(context).accentColor,),),),
                               ),
                             ),
                           ],
                         ),
